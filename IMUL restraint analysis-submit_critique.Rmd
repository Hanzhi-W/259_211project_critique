...
# critique: The code is to much. Is there a smarter way to export the table into a word document? Or, if I'm going to write the manuscript in R markdown, what is the best way to insert the table in my R markdown?
```
